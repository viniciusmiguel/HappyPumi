...
// Use the local Apache-2.0 SDK checkout so the suite builds offline / clean-room (no network).
// Path is relative to this module: HappyPumi/HappyPumi.AutomationApi.IntegrationTests/autoapi.
