...
/// CompleteUpdate
/// </summary>
public sealed class CompleteUpdatePreviewEndpoint(UpdateLifecycle lifecycle, StackWebhookTrigger webhooks) : Endpoint<CompleteUpdatePreviewRequest>
{
    ...
    public async override Task HandleAsync(CompleteUpdatePreviewRequest req, CancellationToken ct)
    {
